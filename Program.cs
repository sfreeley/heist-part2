...
namespace Heist
{
    class Program
    {
        ...
        {
            Hacker gina = new Hacker("gina", 40, 30);
            Muscle greg = new Muscle("greg", 90, 2);
            LockSpecialist martin = new LockSpecialist("martin", 99, 20);
            Hacker sophie = new Hacker("sophie", 70, 10);
            Muscle paul = new Muscle("paul", 20, 90);
